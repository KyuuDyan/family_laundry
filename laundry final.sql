...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2024 at 11:26 AM
...
(2, 'Haykal', 'e158819e4e50d4e009de893e61320d1c');
...
INSERT INTO `jenis` (`id_jenis`, `jenis_laundry`, `lama_proses`, `tarif`) VALUES
(1, 'Cuci Kering', 2, 6000),
(2, 'Cuci Setrika', 3, 7000),
(3, 'Setrika Saja', 1, 5000);
...
(8, 'Haykal', '089519040100', 'Jl.Balai Tangah'),
(9, 'Ikhsan', '084432322111', 'Jl.Balai Gadang');
...
INSERT INTO `transaksi` (`transaksi_id`, `transaksi_tgl`, `transaksi_pelanggan`, `transaksi_harga`, `transaksi_berat`, `transaksi_tgl_selesai`, `transaksi_status`, `id_jenis`) VALUES
(15, '2024-07-03', 9, 6000, 1, '2024-07-04', 2, 1),
(16, '2024-07-03', 8, 18000, 3, '2024-07-04', 2, 1),
(17, '2024-07-03', 9, 35000, 5, '2024-07-05', 1, 2);
...
--
ALTER TABLE `pakaian`
  MODIFY `pakaian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
