...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-10 col-md-offset-1">
            <?php
            $id = $_GET['id'];
            $transaksi = mysqli_query($koneksi, "SELECT transaksi.*, pelanggan.*, jenis.jenis_laundry, jenis.tarif 
                                                 FROM transaksi 
                                                 JOIN pelanggan ON transaksi.transaksi_pelanggan = pelanggan.pelanggan_id 
                                                 JOIN jenis ON transaksi.id_jenis = jenis.id_jenis 
            ...
            while ($t = mysqli_fetch_array($transaksi)) {
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>Jenis Laundry</th>
                        <th>:</th>
                        <td><?php echo $t['jenis_laundry']; ?></td>
                    </tr>
                    <tr>
                        <th>Tarif</th>
                        <th>:</th>
                        <td><?php echo "Rp. " . number_format($t['tarif']) . " ,-"; ?></td>
                    </tr>
                    <tr>
