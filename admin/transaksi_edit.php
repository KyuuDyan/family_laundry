                    ...
                    <form method="post" action="transaksi_update.php">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="jenis_laundry" required="required">
                                ...
                                <?php
                                $jenis_laundry = mysqli_query($koneksi, "SELECT * FROM jenis");
                                while ($j = mysqli_fetch_array($jenis_laundry)) {
                                    ?>
                                    <option <?php if ($j['id_jenis'] == $t['id_jenis']) { echo "selected='selected'"; } ?> value="<?php echo $j['id_jenis']; ?>"><?php echo $j['jenis_laundry'] . " - Rp. " . number_format($j['tarif']); ?></option>
                                    <?php
                                }
                                ?>
                            </select>
